...
import { fetch_user_Approve, fetch_user_notApprove, get_users_approved_by_member, get_users_by_member, useApproveUser, useFetchUserById, User } from "components/fectData/fetch_user";
...
const ListUser: React.FC = () => {
  ...
  //     if (role === "MEMBER") {
  //       console.log(role);
  //      // const txx = await copyrightContract?.addMember(address, name, email, "");
  //       console.log(txx);
  //     }
  //     else {
  ...
  return (
    <BaseLayout>
      <div className="p-4">
        <h1 className="text-lg font-bold mb-4">User Manage</h1>
